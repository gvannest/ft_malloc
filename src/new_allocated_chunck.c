...
void			create_new_free_chunk(void **begin_free, t_chunk *selected_chunk, size_t chunk_size, t_heapheader *current_heap)
{
	...
	update_freelist(new_chunk->prev_chunk, new_chunk, new_chunk->next_freechunk);
	...
	if (next_block < current_heap->current_footer)
		*((t_chunk*)next_block) = ft_set_header_free(free_size, ((t_chunk*)next_block)->mchunk_size | P_FLAG, ((t_chunk*)next_block)->prev_chunk, ((t_chunk*)next_block)->next_freechunk);
